...
- [x] **Task 4: Lista UI** (AC: 1, 2, 3, 4, 5, 6)
  - [x] 4.1 Refazer componente de lista de cadências
  - [x] 4.2 Componente Tabs (Padrão/E-mail Automático) com badge count
  - [x] 4.3 Barra de filtros com selects
  - [x] 4.4 PriorityIcon component (seta colorida)
  - [x] 4.5 ActionMenu por cadência (DropdownMenu)
  - [x] 4.6 Contagem dinâmica

- [x] **Task 5: Testes**
  - [x] 5.1 Testes para filtros de cadência
...
### File List
- `supabase/migrations/20260221_000007_cadence_columns.sql` — NEW
- `src/features/cadences/types/index.ts` — MODIFIED (CadencePriority, CadenceOrigin, CadenceType)
- `src/features/cadences/index.ts` — MODIFIED (barrel exports)
- `src/features/cadences/actions/fetch-cadences.ts` — MODIFIED (filters + fetchCadenceTabCounts)
- `src/features/cadences/actions/fetch-cadences.test.ts` — MODIFIED (baseCadence updated)
- `src/features/cadences/components/PriorityIcon.tsx` — NEW
- `src/features/cadences/components/PriorityIcon.test.tsx` — NEW
- `src/features/cadences/components/CadenceListView.tsx` — MODIFIED (tabs, filters, PriorityIcon, action menu)
- `src/features/cadences/components/CadenceListView.test.tsx` — MODIFIED (7 new tests + fixture updates)
- `src/features/cadences/components/CadenceBuilder.test.tsx` — MODIFIED (fixture updated)
- `src/app/(app)/cadences/page.tsx` — MODIFIED (new filters + tabCounts)
