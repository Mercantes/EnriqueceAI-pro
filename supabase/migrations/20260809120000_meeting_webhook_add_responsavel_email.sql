...
-- =============================================================================
-- Meeting webhook — adiciona responsavel_email (e-mail do closer) — 2026-08-09
-- O closer é uma entidade própria (tabela closers, não auth.users). O e-mail
-- dele = calendar_id da agenda que o n8n lê/move. Coluna adicionada no FIM
-- (restrição do CREATE OR REPLACE VIEW).
-- =============================================================================
