...
describe('fetchExtratoData', () => {
  ...
  it('should group SDR breakdown by user', async () => {
    const calls = [
      // #1 e #2: atendidas (answered_at) E >= 50s → conectadas.
      { id: '1', user_id: 'u1', status: 'significant', duration_seconds: 120, answered_at: '2026-01-15T10:00:03Z', cost: 0.50, started_at: '2026-01-15T10:00:00Z' },
      { id: '2', user_id: 'u1', status: 'not_significant', duration_seconds: 60, answered_at: '2026-01-15T11:00:04Z', cost: 0.20, started_at: '2026-01-15T11:00:00Z' },
      // #3: curta / sem answered → não conecta.
