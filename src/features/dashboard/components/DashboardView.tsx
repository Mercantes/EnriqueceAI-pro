...
export function DashboardView({ data, filters, ranking, insights, responseTime }: DashboardViewProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {ranking && (
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4 [&>*]:min-h-[480px]" data-slot="ranking-cards">
          ...
          <RankingCard
            ...
            idealColumnLabel="ideal dia"
            idealColumnTooltip="Onde cada SDR deveria estar hoje: a meta individual de reuniões marcadas do SDR (em Editar metas) no ritmo de dias úteis (sem feriados). Sem meta individual, usa a fatia da meta do time ÷ SDRs."
      ...
      {insights && (
        <div className="grid grid-cols-1 gap-6 [&>*]:min-h-[480px]" data-slot="insights-charts">
