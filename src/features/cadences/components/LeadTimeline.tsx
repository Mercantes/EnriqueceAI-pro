            ...
            <div className="space-y-6">
              {entries.map((entry) => {
                ...
                const systemTitles: Record<string, string> = {
                  ...
                  activity_skipped: 'Atividade adiada',
                  activity_postponed: 'Atividade adiada',
                  scheduled_activity_completed: 'Atividade agendada concluída',
                  scheduled_activity_cancelled: 'Atividade agendada cancelada',
                  ...
                  cadence_limbo_triaged: 'Retirado do limbo de cadência',
